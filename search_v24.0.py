...
def print_menu(options, title="Menu"):
    global banner  # Declara banner como variável global
    clean()
    print(f"{Fore.BLUE}{banner}{Fore.RESET}")  # Exibe o banner antes do menu
    print(f"\n{title}")
...
def selecionar_pasta_db(pastas_db: List[Path]) -> Optional[Path]:
    ...
    clean()
    print(f"{Fore.BLUE}{banner}{Fore.RESET}")  # Exibe o banner
...
def buscar_logins(diretorio: Path, termo_busca: str, tipo_login: str) -> int:
    ...
    clean()
    print(f"{Fore.BLUE}{banner}{Fore.RESET}")  # Exibe o banner após a busca
...
def remover_duplicados():
    ...
    clean()
    print(f"{Fore.BLUE}{banner}{Fore.RESET}")  # Exibe o banner após a remoção de duplicados
    ...
    try:
        with file_path.open('rb') as f:
            while True:
                ...
                part_num += 1
        clean()
        print(f"{Fore.BLUE}{banner}{Fore.RESET}")  # Exibe o banner após a divisão
